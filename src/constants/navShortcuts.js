...
export const NAV_SHORTCUT_LABELS = {
    ...
    "/all": "All tasks — custom order · Alt+5",
    "/completed": "Completed — can reopen · Alt+3",
    "/trash": "Trash — restore or delete · Alt+4",
    "/focus": "Focus — one task + Pomodoro · Alt+F",
    "/streak": "Streak — heatmap + consecutive days · Alt+6",
}
