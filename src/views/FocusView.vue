    ...
    <section class="max-w-lg mx-auto text-center">
        ...
        <div v-if="current" class="rounded-2xl border border-light/20 bg-gray/50 p-6 text-left">
            ...
            <div class="flex flex-wrap gap-2 justify-center mb-6">
                <Tooltip text="Complete this task and pick the next" position="top" inline>
                    <button
                        type="button"
                ...
                <Tooltip text="Focus the next due task instead" position="top" inline>
            ...
            <div class="border-t border-light/10 pt-4">
                ...
                <div class="flex flex-wrap gap-2 justify-center">
                    ...
                    <Tooltip text="Start break timer" position="top" inline>
                        <button
                            type="button"
                            class="text-sm px-3 py-1 rounded-lg border border-light/25 flex items-center gap-1.5"
                    ...
                    <Tooltip text="Stop the timer" position="top" inline>
